...
// Fetch messages from the database, including sender and receiver names
$sql = "
...
// Reusable string
$inboxInfo = "This is your general inbox. Private Messages is in the <b>Messages</b> Tab.";
?>
    ...
    <?php if ($messages): ?>
        ...
        <?php foreach ($messages as $message): ?>
            <div class="message">
                ...
                <!-- Display replies (optional) -->
                <?php
                // Modify the replies query to join with the 'users' table to get the sender's name
                $replies_sql = "
